    ...
    <div class="bg-white w-full h-max lg:rounded-xl shadow-sm p-4 lg:p-8">
        ...
        <div class="w-full gap-3 flex flex-row">
            ...
            <div class="container w-100">
                <form class="grid justify-items-end mr-1" action="/cetak" method="GET">
                    ...
                    <div class="flex space-x-4">
                        <div class="p-2 bg-red-600 hover:bg-red-500  text-white font-semibold text-center w-36" style="font-size: 16px; border-radius: 15px;">
                            <button type="submit" class="text"><i class="fa-solid fa-filter pt-2"></i> Cetak PDF</button>
                        </div>
                    </div>
                    </form>
                </div>
