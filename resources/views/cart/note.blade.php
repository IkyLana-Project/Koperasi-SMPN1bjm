...
<body onload="window.print()" >
    ...
    <div class="kembali">
        <a href="/beranda" class="bg-green-500 hover:bg-green-400 hover:duration-150 text-white rounded-lg px-3 py-2 m-3"><i class="fa-solid fa-arrow-left"></i> Kembali </a>
    </div>
</body>
</html>
