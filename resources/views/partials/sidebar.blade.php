    ...
    <div class="mt-8 w-full flex flex-col">
        ...
        <ul class="mt-4 w-full px-3 flex flex-col">
            ...
            @if(auth()->user()->user == 'admincetak')
                    ...
                    <li>
                        <a href="/history" class="w-full flex px-3 py-2 rounded-lg {{ $active == 'history' ? 'bg-slate-200' : 'text-slate-500' }}">History</a>
                    </li>
                    <li>
                        <a href="/export" class="w-full flex px-3 py-2 rounded-lg {{ $active == 'halamancetak' ? 'bg-slate-200' : 'text-slate-500' }}">Cetak History</a>
                    </li>
            @endif
                </li>
